                    ...
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="flex flex-col justify-between">
                            <div>
                                ...
                                <div class="text-gray-600 text-sm">Sold by <a rel="noopener" :href="item.vendor.url + '?ref=vapecrawl.ca&rel=noopener'" target="_blank" :title="item.vendor.name">{{ item.vendor.name }}</a></div>
                            </div>
                            <div class="flex">
